...
int c3()
{
    printf("\n\n          ¢i¢i¢i¢i¢i¢iùß          \n");    printf("          ùãùùùùùùùù¢i¢iùß         \n");    printf("           ¢i¢i¢i¢i¢iùÝùå         \n");    printf("           ùãùùùùùù¢i¢iùß         \n");    printf("          ¢i¢i¢i¢i¢i¢iùÝùå¢i¢iùß¢i¢iùß¢i¢iùß\n");    printf("          ùãùùùùùùùùùùùå ùãùùùåùãùùùåùãùùùå\n");}
int c2()
{
    printf("\n\n          ¢i¢i¢i¢i¢i¢iùß\n");    printf("          ùãùùùùùùùù¢i¢iùß\n");    printf("           ¢i¢i¢i¢i¢iùÝùå\n");    printf("          ¢i¢iùÝùùùùùùùå\n");    printf("          ¢i¢i¢i¢i¢i¢i¢iùß¢i¢iùß¢i¢iùß¢i¢iùß\n");    printf("          ùãùùùùùùùùùùùùùåùãùùùåùãùùùåùãùùùå\n");}
int c1()
{
    printf("\n\n           ¢i¢iùß\n");     printf("          ¢i¢i¢iùø\n");    printf("          ùã¢i¢iùø\n");    printf("           ¢i¢iùø\n");    printf("           ¢i¢iùø¢i¢iùß¢i¢iùß¢i¢iùß\n");    printf("           ùãùùùåùãùùùåùãùùùåùãùùùå\n");}
int cgo()
{
    printf("\n\n           ¢i¢i¢i¢i¢i¢iùß  ¢i¢i¢i¢i¢i¢iùß ¢i¢iùß\n");    printf("          ¢i¢iùÝùùùùùùùùùå ¢i¢iùÝùùùùùù¢i¢iùß¢i¢iùø\n");    printf("          ¢i¢iùø  ¢i¢i¢iùß¢i¢iùø   ¢i¢iùø¢i¢iùø\n");    printf("          ¢i¢iùø   ¢i¢iùø¢i¢iùø   ¢i¢iùøùãùùùå\n");    printf("          ùã¢i¢i¢i¢i¢i¢iùÝùåùã¢i¢i¢i¢i¢i¢iùÝùå¢i¢iùß\n");    printf("           ùãùùùùùùùùùùùå  ùãùùùùùùùùùùùå ùãùùùå\n");}
...
int start()
{
    ...
    for(int i=1; i>0; i++){
        ...
        if(i%2==0){
            printf("       > ");
            printf("press [A] for English, «ö¤U[B]¥H¨Ï¥Î¤¤¤å");
            printf(" <");
            printf("\n");
        }
        else{
...
int tutorialz()
{
    ...
    cls();
    logo();
    printf("Åwªï¨Ó¨ì Dick Fight!\n³o¸Ì¬O¹CÀ¸±Ð¾Ç¡C\n\n\n");
    printf("                >> «ö¤U [ENTER] Áä¥HÄ~Äò\n                         [Q]     Áä¥H¸õ¹L±Ð¾Ç\n");
    int r=key();
    if(r==3){
        cls();
        logo();
        printf("¦b³o¹CÀ¸¤¤¡A±N·|¦³«Ü¦hDick¾É¼u§ðÀ»±z¡C ¦pªG¦³Dick¾É¼u¸I¨ì¤F±zªºDick¡A±z±N·|¶§·õ(¦º¤`)¡C\n±z¥²¶·¨Ï¥Î [A] ©M [D] Áä¨Ó²¾°Ê±zªºDick¡C±z¥i¥H¨Ï¥Î [W] Áä¨Ó®gÀ»Dick¾É¼u¥H±o¨ì¤À¼Æ¡C\n ±z¥i¥H²{¦b«ö¤U [W] «öÁä´ú¸ÕÁä½L¬O§_¦³¥Î¡C\n\n");
        printf("                >> «ö¤U [ENTER] Áä¥HÄ~Äò\n");
        printf("                >> «ö¤U [W]     Áä¶i¤JÁä½L´ú¸Õ°Ï°ì\n");
        if(key()==4){
            while(1)
            {
                wasd(0);
        ...
        cls();
        logo();
        printf("¹CÀ¸¦b¤@¬q®É¶¡«á·|¥[³t(Dick¾É¼u·|ÅÜ§Ö)¡C\n\n\n");
        printf("                >> «ö¤U [ENTER] Áä¥HÄ~Äò\n");
        getch();
        cls();
        logo();
        printf("±z·Ç³Æ¦n¤F¶Ü??\n\n\n");
        printf("                >> «ö¤U [ENTER] Áä¥H¶i¤J¹CÀ¸\n");
        getch();
        ready();
    }
    else if(r==1){
...
{
    printf("¤À¼Æ: %d  |  ®É¶¡¨è: %d (TPS:%d) | «ö¤U [ENTER] ¨Óµ²§ô¹CÀ¸\n",score, tick, tps);
    return 0;
}
...
int end(int score)
{
    for(int sp=60;sp>10;sp+=-1){
        cls();
        space(sp); printf(" ¢i¢i¢i¢i¢i¢iùß  ¢i¢i¢i¢i¢iùß ¢i¢i¢iùß   ¢i¢i¢iùß¢i¢i¢i¢i¢i¢i¢iùß\n");
        space(sp); printf("¢i¢iùÝùùùùùùùùùå ¢i¢iùÝùùùù¢i¢iùß¢i¢i¢i¢iùß ¢i¢i¢i¢iùø¢i¢iùÝùùùùùùùùùå\n");
        space(sp); printf("¢i¢iùø  ¢i¢i¢iùß¢i¢i¢i¢i¢i¢i¢iùø¢i¢iùÝ¢i¢i¢i¢iùÝ¢i¢iùø¢i¢i¢i¢i¢iùß  \n");
        space(sp); printf("¢i¢iùø   ¢i¢iùø¢i¢iùÝùùùù¢i¢iùø¢i¢iùøùã¢i¢iùÝùå¢i¢iùø¢i¢iùÝùùùùùå  \n");
        space(sp); printf("ùã¢i¢i¢i¢i¢i¢iùÝùå¢i¢iùø  ¢i¢iùø¢i¢iùø ùãùùùå ¢i¢iùø¢i¢i¢i¢i¢i¢i¢iùß\n");
        space(sp); printf(" ùãùùùùùùùùùùùå ùãùùùå  ùãùùùåùãùùùå     ùãùùùåùãùùùùùùùùùùùùùå\n");
        space(sp); printf("                                    \n");
        space(sp); printf(" ¢i¢i¢i¢i¢i¢iùß ¢i¢iùß   ¢i¢iùß¢i¢i¢i¢i¢i¢i¢iùß¢i¢i¢i¢i¢i¢iùß   \n");
        space(sp); printf("¢i¢iùÝùùùùùù¢i¢iùß¢i¢iùø   ¢i¢iùø¢i¢iùÝùùùùùùùùùå¢i¢iùÝùùùù¢i¢iùß  \n");
        space(sp); printf("¢i¢iùø   ¢i¢iùø¢i¢iùø   ¢i¢iùø¢i¢i¢i¢i¢iùß  ¢i¢i¢i¢i¢i¢iùÝùå  \n");
        space(sp); printf("¢i¢iùø   ¢i¢iùøùã¢i¢iùß ¢i¢iùÝùå¢i¢iùÝùùùùùå  ¢i¢iùÝùùùù¢i¢iùß  \n");
        space(sp); printf("ùã¢i¢i¢i¢i¢i¢iùÝùå ùã¢i¢i¢i¢iùÝùå ¢i¢i¢i¢i¢i¢i¢iùß¢i¢iùø  ¢i¢iùø  \n");
        space(sp); printf(" ùãùùùùùùùùùùùå   ùãùùùùùùùå  ùãùùùùùùùùùùùùùåùãùùùå  ùãùùùå  \n");
